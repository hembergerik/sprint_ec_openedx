...
function node_to_str(tree, str) {
    ...
    if (typeof tree[0] !== 'string') {
        console.log('NOT STRING 1.1 node to str:', tree[0]);
        tree[0] = tree[0].join('');
        console.log('NOT STRING 1.2 node to str:', tree[0]);
    }
    str += tree[0];
...
gp(population_size=40, max_size=2, generations=4, mutation_probability=1.0, tournament_size=2, crossover_probability=0.0);
})();